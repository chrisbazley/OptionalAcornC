 ...
 */
 ...
 extern _Optional _kernel_oserror *textarea_replace_text ( unsigned int flags,
                                                 ObjectId window,
                                                 ComponentId textarea,
                                                 unsigned int index_start,
                                                 unsigned int index_end,
 ...
 extern _Optional _kernel_oserror *textarea_insert_text ( unsigned int flags,
                                                ObjectId window,
                                                ComponentId textarea,
                                                unsigned int index,
                                                const char *text
 ...
 extern _Optional _kernel_oserror *textarea_set_state ( unsigned int flags,
                                              ObjectId window,
                                              ComponentId textarea,
                                              unsigned int state
                                            );
 ...
 extern _Optional _kernel_oserror *textarea_get_selection_text ( unsigned int flags,
                                                       ObjectId window,
                                                       ComponentId textarea,
                                                       char *buffer,
                                                       int size,
 ...
 extern _Optional _kernel_oserror *textarea_set_selection ( unsigned int flags,
                                                  ObjectId window,
                                                  ComponentId textarea,
                                                  unsigned int index_start,
                                                  unsigned int index_end
 ...
 extern _Optional _kernel_oserror *textarea_set_colour ( unsigned int flags,
                                               ObjectId window,
                                               ComponentId textarea,
                                               unsigned int foreground,
                                               unsigned int background
 ...
 extern _Optional _kernel_oserror *textarea_get_text ( unsigned int flags,
                                             ObjectId window,
                                             ComponentId writable,
                                             char *buffer,
                                             int buff_size,
 ...
 extern _Optional _kernel_oserror *textarea_set_text ( unsigned int flags,
                                             ObjectId window,
                                             ComponentId writable,
                                             const char *text
                                           );
 ...
 extern _Optional _kernel_oserror *textarea_set_font ( unsigned int flags,
                                             ObjectId window,
                                             ComponentId textarea,
                                             const char *font_name,
                                             unsigned int width,
 ...
 extern _Optional _kernel_oserror *textarea_set_cursor_position ( unsigned int flags,
                                                        ObjectId window,
                                                        ComponentId textarea,
                                                        unsigned int index,
