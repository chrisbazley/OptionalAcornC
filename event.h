 ...
 ***************************************************************************/
 ...
 extern _Optional _kernel_oserror *event_poll (_Optional int *event_code, _Optional WimpPollBlock *poll_block, _Optional void *poll_word);
 
 
 extern _Optional _kernel_oserror *event_poll_idle (_Optional int *event_code, _Optional WimpPollBlock *poll_block, unsigned int earliest, _Optional void *poll_word);
 
 
 extern _Optional _kernel_oserror *event_dispatch (int event_code, WimpPollBlock *poll_block);
 
 
 /* ------------------------------------- getting/setting poll mask -------------------------------- */
 
 extern _Optional _kernel_oserror *event_set_mask (unsigned int mask);
 
 extern _Optional _kernel_oserror *event_get_mask (unsigned int *mask);
 ...
 extern _Optional _kernel_oserror *event_initialise (IdBlock *b);
