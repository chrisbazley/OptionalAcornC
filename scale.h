 ...
 */
 ...
 extern _Optional _kernel_oserror *scale_get_title ( unsigned int flags,
                                           ObjectId scale,
                                           char *buffer,
                                           int buff_size,
                                           int *nbytes
 ...
 extern _Optional _kernel_oserror *scale_set_bounds ( unsigned int flags,
                                            ObjectId scale,
                                            int lower_bound,
                                            int upper_bound,
                                            int step_size
 ...
 extern _Optional _kernel_oserror *scale_set_value ( unsigned int flags,
                                           ObjectId scale,
                                           int value
                                         );
