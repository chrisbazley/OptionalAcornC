 ...
 */
 ...
 extern _Optional _kernel_oserror *window_wimp_to_toolbox ( unsigned int flags,
                                                  int window_handle,
                                                  int icon_handle,
 ...
 extern _Optional _kernel_oserror *window_get_tool_bars ( unsigned int flags,
                                                ObjectId window,
                                                _Optional ObjectId *ibl,
                                                _Optional ObjectId *itl,
                                                _Optional ObjectId *ebl,
                                                _Optional ObjectId *etl
                                              );
 ...
 extern _Optional _kernel_oserror *window_set_tool_bars ( unsigned int flags,
                                                ObjectId window,
                                                ObjectId ibl,
                                                ObjectId itl,
                                                ObjectId ebl,
 ...
 extern _Optional _kernel_oserror *window_set_menu ( unsigned int flags,
                                           ObjectId window,
                                           ObjectId menu_id
                                         );
 ...
 extern _Optional _kernel_oserror *window_remove_gadget ( unsigned int flags,
                                                ObjectId window,
                                                ComponentId gadget
                                              );
 ...
 extern _Optional _kernel_oserror *window_get_pointer ( unsigned int flags,
                                              ObjectId window,
                                              char *buffer,
                                              int buff_size,
                                              int *nbytes,
 ...
 extern _Optional _kernel_oserror *window_get_help_message ( unsigned int flags,
                                                   ObjectId window,
                                                   char *buffer,
                                                   int buff_len,
                                                   int *nbytes
 ...
 extern _Optional _kernel_oserror *window_get_title ( unsigned int flags,
                                            ObjectId window,
                                            char *buffer,
                                            int buff_size,
                                            int *nbytes
 ...
 extern _Optional _kernel_oserror *window_set_default_focus ( unsigned int flags,
                                                    ObjectId window,
                                                    ComponentId focus
                                                  );
 ...
 extern _Optional _kernel_oserror *window_get_extent ( unsigned int flags,
                                             ObjectId window,
                                             BBox *extent
                                           );
