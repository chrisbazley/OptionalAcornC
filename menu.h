 ...
 */
 ...
 extern _Optional _kernel_oserror *menu_get_title ( unsigned int flags,
                                          ObjectId menu,
                                          char *buffer,
                                          int buff_size,
                                          int *nbytes
 ...
 extern _Optional _kernel_oserror *menu_remove_entry ( unsigned int flags,
                                             ObjectId menu,
                                             ComponentId entry
                                           );
 ...
 extern _Optional _kernel_oserror *menu_get_help_message ( unsigned int flags,
                                                 ObjectId menu,
                                                 char *buffer,
                                                 int buff_size,
                                                 int *nbytes
 ...
 extern _Optional _kernel_oserror *menu_get_entry_help_message ( unsigned int flags,
                                                       ObjectId menu,
                                                       ComponentId entry,
                                                       char *buffer,
                                                       int buff_size,
 ...
 extern _Optional _kernel_oserror *menu_set_click_event ( unsigned int flags,
                                                ObjectId menu,
                                                ComponentId entry,
                                                int toolbox_event
                                              );
 ...
 extern _Optional _kernel_oserror *menu_set_click_show ( unsigned int flags,
                                               ObjectId menu,
                                               ComponentId entry,
                                               ObjectId object,
                                               int show_flags
 ...
 extern _Optional _kernel_oserror *menu_set_sub_menu_event ( unsigned int flags,
                                                   ObjectId menu,
                                                   ComponentId entry,
                                                   int toolbox_event
                                                 );
 ...
 extern _Optional _kernel_oserror *menu_set_sub_menu_show ( unsigned int flags,
                                                  ObjectId menu,
                                                  ComponentId entry,
                                                  ObjectId sub_menu
                                                );
 ...
 extern _Optional _kernel_oserror *menu_get_entry_sprite ( unsigned int flags,
                                                 ObjectId menu,
                                                 ComponentId entry,
                                                 char *buffer,
                                                 int buff_size,
 ...
 extern _Optional _kernel_oserror *menu_get_entry_text ( unsigned int flags,
                                               ObjectId menu,
                                               ComponentId entry,
                                               char *buffer,
                                               int buff_size,
 ...
 extern _Optional _kernel_oserror *menu_set_fade ( unsigned int flags,
                                         ObjectId menu,
                                         ComponentId entry,
                                         int fade
                                       );
 ...
 extern _Optional _kernel_oserror *menu_set_tick ( unsigned int flags,
                                         ObjectId menu,
                                         ComponentId entry,
                                         int tick
                                       );
