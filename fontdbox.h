 ...
 */
 ...
 extern _Optional _kernel_oserror *fontdbox_get_title ( unsigned int flags,
                                              ObjectId fontdbox,
                                              char *buffer,
                                              int buff_size,
                                              int *nbytes
 ...
 extern _Optional _kernel_oserror *fontdbox_get_try_string ( unsigned int flags,
                                                   ObjectId fontdbox,
                                                   char *buffer,
                                                   int buff_size,
                                                   int *nbytes
 ...
 extern _Optional _kernel_oserror *fontdbox_set_size ( unsigned int flags,
                                             ObjectId fontdbox,
                                             int height,
                                             int aspect_ratio
                                           );
 ...
 extern _Optional _kernel_oserror *fontdbox_get_font ( unsigned int flags,
                                             ObjectId fontdbox,
                                             char *buffer,
                                             int buff_size,
                                             int *nbytes
