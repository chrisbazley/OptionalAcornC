 ...
 */
 ...
 extern _Optional _kernel_oserror *iconbar_set_menu ( unsigned int flags,
                                            ObjectId iconbar,
                                            ObjectId menu_id
                                          );
 ...
 extern _Optional _kernel_oserror *iconbar_set_event ( unsigned int flags,
                                             ObjectId iconbar,
                                             int select_event,
                                             int adjust_event
                                           );
 ...
 extern _Optional _kernel_oserror *iconbar_set_show ( unsigned int flags,
                                            ObjectId iconbar,
                                            ObjectId select,
                                            ObjectId adjust
                                          );
 ...
 extern _Optional _kernel_oserror *iconbar_get_help_message ( unsigned int flags,
                                                    ObjectId iconbar,
                                                    char *buffer,
                                                    int buff_size,
 ...
 extern _Optional _kernel_oserror *iconbar_get_text ( unsigned int flags,
                                            ObjectId iconbar,
                                            char *buffer,
                                            int buff_size,
                                            _Optional int *nbytes
 ...
 extern _Optional _kernel_oserror *iconbar_get_sprite ( unsigned int flags,
                                              ObjectId iconbar,
                                              char *buffer,
                                              int buff_len,
                                              _Optional int *nbytes
