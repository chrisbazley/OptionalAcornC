 ...
 */
 ...
 extern _Optional _kernel_oserror *gadget_get_bbox ( unsigned int flags,
                                            ObjectId window,
                                            ComponentId gadget,
                                            BBox *box
                                          );
 ...
 extern _Optional _kernel_oserror *gadget_set_focus ( unsigned int flags,
                                            ObjectId window,
                                            ComponentId component
                                          );
 ...
 extern _Optional _kernel_oserror *gadget_move_gadget ( unsigned int flags,
                                              ObjectId window,
                                              ComponentId gadget,
                                              BBox *new_bbox
                                            );
 ...
 extern _Optional _kernel_oserror *gadget_get_icon_list ( unsigned int flags,
                                                ObjectId window,
                                                ComponentId gadget,
                                                _Optional int *buffer,
                                                int buff_size,
 ...
 extern _Optional _kernel_oserror *gadget_get_help_message ( unsigned int flags,
                                                   ObjectId window,
                                                   ComponentId gadget,
                                                   char *buffer,
                                                   int buff_size,
 ...
 extern _Optional _kernel_oserror *gadget_set_flags ( unsigned int flags,
                                            ObjectId window,
                                            ComponentId gadget,
                                            unsigned int new_flags_settings
                                          );
 ...
 extern _Optional _kernel_oserror *actionbutton_get_text ( unsigned int flags,
                                                 ObjectId window,
                                                 ComponentId action_button,
                                                 char *buffer,
                                                 int buff_size,
 ...
 extern _Optional _kernel_oserror *actionbutton_set_event ( unsigned int flags,
                                                  ObjectId window,
                                                  ComponentId action_button,
                                                  int event
                                                );
 ...
 extern _Optional _kernel_oserror *actionbutton_set_click_show ( unsigned int flags,
                                                       ObjectId window,
                                                       ComponentId action_button,
                                                       ObjectId object,
                                                       unsigned int show_flags
 ...
 extern _Optional _kernel_oserror *actionbutton_set_font ( unsigned int flags,
                                                 ObjectId window,
                                                 ComponentId action_button,
                                                 const char *font_name,
                                                 unsigned int width,
 ...
 extern _Optional _kernel_oserror *optionbutton_get_label ( unsigned int flags,
                                                  ObjectId window,
                                                  ComponentId option_button,
                                                  char *buffer,
                                                  int buff_size,
 ...
 extern _Optional _kernel_oserror *optionbutton_set_event ( unsigned int flags,
                                                  ObjectId window,
                                                  ComponentId option_button,
                                                  int event
                                                );
 ...
 extern _Optional _kernel_oserror *optionbutton_set_state ( unsigned int flags,
                                                  ObjectId window,
                                                  ComponentId option_button,
                                                  int state
                                                );
 ...
 extern _Optional _kernel_oserror *radiobutton_get_label ( unsigned int flags,
                                                 ObjectId window,
                                                 ComponentId radio_button,
                                                 char *buffer,
                                                 int buff_size,
 ...
 extern _Optional _kernel_oserror *radiobutton_get_state ( unsigned int flags,
                                                 ObjectId window,
                                                 ComponentId radio_button,
                                                 _Optional int *state,
                                                 _Optional ComponentId *selected
                                               );
 ...
 extern _Optional _kernel_oserror *radiobutton_set_state ( unsigned int flags,
                                                 ObjectId window,
                                                 ComponentId radio_button,
                                                 int state
                                               );
 ...
 extern _Optional _kernel_oserror *radiobutton_set_event ( unsigned int flags,
                                                 ObjectId window,
                                                 ComponentId radio_button,
                                                 int event
                                               );
 ...
 extern _Optional _kernel_oserror *displayfield_get_value ( unsigned int flags,
                                                  ObjectId window,
                                                  ComponentId display_field,
                                                  char *buffer,
                                                  int buff_size,
 ...
 extern _Optional _kernel_oserror *slider_set_colour ( unsigned int flags,
                                             ObjectId window,
                                             ComponentId slider,
                                             int bar_colour,
                                             int back_colour
 ...
 extern _Optional _kernel_oserror *slider_set_bounds( unsigned int flags,
                                            ObjectId window,
                                            ComponentId slider,
                                            int upper_bound,
                                            int lower_bound,
 ...
 extern _Optional _kernel_oserror *slider_set_value ( unsigned int flags,
                                            ObjectId window,
                                            ComponentId slider,
                                            int value
                                          );
 ...
 extern _Optional _kernel_oserror *draggable_set_state ( unsigned int flags,
                                               ObjectId window,
                                               ComponentId draggable,
                                               int state
                                             );
 ...
 extern _Optional _kernel_oserror *draggable_get_sprite ( unsigned int flags,
                                                ObjectId window,
                                                ComponentId draggable,
                                                char *buffer,
                                                int buff_size,
 ...
 extern _Optional _kernel_oserror *draggable_get_text ( unsigned int flags,
                                              ObjectId window,
                                              ComponentId draggable,
                                              char *buffer,
                                              int buff_size,
 ...
 extern _Optional _kernel_oserror *popup_set_menu ( unsigned int flags,
                                          ObjectId window,
                                          ComponentId popup,
                                          ObjectId menu
                                        );
 ...
 extern _Optional _kernel_oserror *numberrange_set_value ( unsigned int flags,
                                                 ObjectId window,
                                                 ComponentId number_range,
                                                 int value
                                               );
 ...
 extern _Optional _kernel_oserror *numberrange_set_bounds ( unsigned int flags,
                                                  ObjectId window,
                                                  ComponentId number_range,
                                                  int lower_bound,
                                                  int upper_bound,
 ...
 extern _Optional _kernel_oserror *stringset_get_selected ( unsigned int flags,
                                                  ObjectId window,
                                                  ComponentId string_set,
                                                  ...
                                                );
 ...
 extern _Optional _kernel_oserror *stringset_set_font ( unsigned int flags,
                                              ObjectId window,
                                              ComponentId string_set,
                                              const char *font_name,
                                              unsigned int width,
 ...
 extern _Optional _kernel_oserror *button_set_flags ( unsigned int flags,
                                            ObjectId window,
                                            ComponentId button,
                                            int clear_word,
                                            int EOR_word
 ...
 extern _Optional _kernel_oserror *button_get_value ( unsigned int flags,
                                            ObjectId window,
                                            ComponentId button,
                                            char *buffer,
                                            int buff_size,
 ...
 extern _Optional _kernel_oserror *button_get_validation ( unsigned int flags,
                                                 ObjectId window,
                                                 ComponentId button,
                                                 char *buffer,
                                                 int buff_size,
