...
#define _Optional
 ...
 extern _Optional _kernel_oserror *toolbox_get_sys_info ( unsigned int reason_code,
 ...
 extern _Optional _kernel_oserror *toolbox_get_template_name ( unsigned int flags,
                                                     ObjectId id,
 ...
 extern _Optional _kernel_oserror *toolbox_delete_object ( unsigned int flags,
                                                 ObjectId id
                                               );
 
 
 
 extern _Optional _kernel_oserror *toolbox_template_lookup (unsigned int flags,
                                                  char *name,
                                                  void **id
                                                 );
 ...
 extern _Optional _kernel_oserror *toolbox_hide_object ( unsigned int flags,
                                               ObjectId id
                                             );
 ...
 extern _Optional _kernel_oserror *toolbox_get_object_state ( unsigned int flags,
                                                    ObjectId id,
 ...
 extern _Optional _kernel_oserror *toolbox_set_client_handle ( unsigned int flags,
                                                     ObjectId id,
                                                     void *client_handle
                                                   );
 ...
 extern _Optional _kernel_oserror *toolbox_get_client_handle ( unsigned int flags,
                                                     ObjectId id,
                                                     void *_Optional *client_handle
                                                   );
 ...
 extern _Optional _kernel_oserror *toolbox_get_object_class ( unsigned int flags,
                                                    ObjectId id,
                                                    _Optional ObjectClass *object_class
                                                  );
 ...
 extern _Optional _kernel_oserror *toolbox_get_parent ( unsigned int flags,
                                              ObjectId id,
                                              _Optional ObjectId *parent,
                                              _Optional ComponentId *parent_component
                                            );
 ...
 extern _Optional _kernel_oserror *toolbox_get_ancestor ( unsigned int flags,
                                                ObjectId id,
                                                _Optional ObjectId *ancestor,
                                                _Optional ComponentId *ancestor_component
                                              );
 ...
 extern _Optional _kernel_oserror *toolbox_raise_toolbox_event ( unsigned int flags,
                                                       ObjectId id,
                                                       ComponentId component,
                                                       ToolboxEvent *event
                                                     );
