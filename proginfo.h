 ...
 */
 ...
 extern _Optional _kernel_oserror *proginfo_set_web_event ( unsigned int flags,
                                                  ObjectId proginfo,
                                                  int event
                                                );
 ...
 extern _Optional _kernel_oserror *proginfo_get_uri ( unsigned int flags,
                                            ObjectId proginfo,
                                            char *buffer,
                                            int buff_size,
                                            int *nbytes
 ...
 extern _Optional _kernel_oserror *proginfo_set_uri ( unsigned int flags,
                                            ObjectId proginfo,
                                            const char *uri
                                          );
 ...
 extern _Optional _kernel_oserror *proginfo_get_title ( unsigned int flags,
                                              ObjectId proginfo,
                                              char *buffer,
                                              int buff_size,
                                              int *nbytes
 ...
 extern _Optional _kernel_oserror *proginfo_set_licence_type ( unsigned int flags,
                                                     ObjectId proginfo,
                                                     int licence_type
                                                   );
 ...
 extern _Optional _kernel_oserror *proginfo_get_version ( unsigned int flags,
                                                ObjectId proginfo,
                                                char *buffer,
                                                int buff_size,
                                                int *nbytes
