 ...
 */
 ...
 extern _Optional _kernel_oserror *fileinfo_set_modified ( unsigned int flags,
                                                 ObjectId fileinfo,
                                                 int modified
                                               );
 ...
 extern _Optional _kernel_oserror *fileinfo_set_file_type ( unsigned int flags,
                                                  ObjectId fileinfo,
                                                  int file_type
                                                );
 ...
 extern _Optional _kernel_oserror *fileinfo_get_file_name ( unsigned int flags,
                                                  ObjectId fileinfo,
                                                  char *buffer,
                                                  int buff_size,
                                                  int *nbytes
 ...
 extern _Optional _kernel_oserror *fileinfo_set_file_size ( unsigned int flags,
                                                  ObjectId fileinfo,
                                                  int file_size
                                                );
 ...
 extern _Optional _kernel_oserror *fileinfo_get_date ( unsigned int flags,
                                             ObjectId fileinfo,
                                             int *UTC
                                           );
 ...
 extern _Optional _kernel_oserror *fileinfo_get_title ( unsigned int flags,
                                              ObjectId fileinfo,
                                              char *buffer,
                                              int buff_size,
                                              int *nbytes
