 ...
 */
 ...
 extern _Optional _kernel_oserror *saveas_selection_available ( unsigned int flags,
                                                      ObjectId saveas,
                                                      int selection
                                                    );
 ...
 extern _Optional _kernel_oserror *saveas_set_file_size ( unsigned int flags,
                                                ObjectId saveas,
                                                int file_size
                                              );
 ...
 extern _Optional _kernel_oserror *saveas_set_file_type ( unsigned int flags,
                                                ObjectId saveas,
                                                int file_type
                                              );
 ...
 extern _Optional _kernel_oserror *saveas_get_file_name ( unsigned int flags,
                                                ObjectId saveas,
                                                char *buffer,
                                                int buff_size,
 ...
 extern _Optional _kernel_oserror *saveas_get_title ( unsigned int flags,
                                            ObjectId saveas,
                                            char *buffer,
                                            int buff_size,
                                            int *nbytes
