 ...
 */
 ...
 extern _Optional _kernel_oserror *printdbox_set_draft ( unsigned int flags,
                                               ObjectId printdbox,
                                               int draft
                                             );
 ...
 extern _Optional _kernel_oserror *printdbox_get_title ( unsigned int flags,
                                               ObjectId printdbox,
                                               char *buffer,
                                               int buff_size,
                                               int *nbytes
 ...
 extern _Optional _kernel_oserror *printdbox_set_orientation ( unsigned int flags,
                                                     ObjectId printdbox,
                                                     int orientation
                                                   );
 ...
 extern _Optional _kernel_oserror *printdbox_set_scale ( unsigned int flags,
                                               ObjectId printdbox,
                                               int scale_factor
                                             );
 ...
 extern _Optional _kernel_oserror *printdbox_set_copies ( unsigned int flags,
                                                ObjectId printdbox,
                                                int copies
                                              );
 ...
 extern _Optional _kernel_oserror *printdbox_set_page_range ( unsigned int flags,
                                                    ObjectId printdbox,
                                                    int start,
                                                    int end
                                                  );
